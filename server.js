...
db.serialize(() => {
    ...
    const product = [
        ...
        JSON.stringify([
            ...
            'পুরুষ, মহিলা উভয়ের জন্য উপযুক্ত',
            'সহজে পরিষ্কার করা যায়',
            'Type-B/C ক্যাবল দিয়ে চার্জ দেওয়া যায়',
            'ব্যথাহীন ও নিরাপদ',
            'প্রতিদিনের ব্যবহারে সময় বাঁচায়',
            'স্কিন সেফ রাখে',
            '১ বছর ওয়ারেন্টি'
        ])
    ];
...
<body>
    ...
    <footer class="footer">
        <div class="container text-center">
            <p><i class="fas fa-phone"></i> +880 1330-513726 | <i class="fas fa-envelope"></i> info@dhakamarket.com</p>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><i class="fas fa-shipping-fast text-success"></i> Cash on Delivery</p>
        ...
        content += `</ul>
                ...
                <div class="row mt-5">
                    <div class="col-12">
                        <div class="card border-primary">
                            <div class="card-header bg-primary text-white">
                                <h4 class="mb-0"><i class="fas fa-truck"></i> আপনার তথ্য দিয়ে পণ্য অর্ডার করুন</h4>
                            </div>
                            <div class="card-body">
                                <form action="/order" method="POST" id="orderForm">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="insideDhaka">
                                                    ঢাকার মধ্যে: ৳${shippingInsideDhaka}
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="outsideDhaka">
                                                    ঢাকার বাইরে: ৳${shippingOutsideDhaka}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="alert alert-success">
                                                <h6><i class="fas fa-calculator"></i> আপনার অর্ডার</h6>
                                                <table class="table table-sm table-borderless mb-0">
                                                    <tr>
                                                        <td>${product.name}</td>
                                                        <td>x 1</td>
                                                        <td class="text-end">${formatPrice(product.offer_price)}</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">Shipping</td>
                                                        <td id="shippingCost" class="text-end">৳${shippingInsideDhaka}</td>
                                                    </tr>
                                                    <tr class="border-top">
                                                        <td colspan="2"><strong>Total</strong></td>
                                                        <td id="totalAmount" class="text-end"><strong>${formatPrice(defaultTotal)}</strong></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center mt-3">
                                        <button type="submit" class="btn btn-danger btn-lg w-100 py-3" style="font-size: 1.2rem;">
                                            <i class="fas fa-shopping-cart"></i> অর্ডার কনফার্ম করছি ${formatPrice(defaultTotal)}
                                        </button>
                    ...
                    <div class="col-md-4">
                        <div class="card text-center h-100">
                            <div class="card-body">
                                ...
                                <h5>24/7 Support</h5>
                                <p class="text-muted">Call us anytime: +880 1330-513726</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <script>
                function calculateTotal() {
                    ...
                    document.getElementById('totalAmount').innerHTML = '<strong>${formatPrice(product.offer_price)}</strong>';
                    document.getElementById('shippingCost').textContent = '৳' + shippingCost;
                    document.getElementById('totalAmount').innerHTML = '<strong>৳' + total.toLocaleString('en-IN') + '</strong>';
                    
                    document.querySelector('.btn').innerHTML = '<i class="fas fa-shopping-cart"></i> অর্ডার কনফার্ম করছি ৳' + total.toLocaleString('en-IN');
                }
                                ...
                                <div class="card border-success shadow-lg">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <div class="d-grid gap-2">
                                            ...
                                            <a href="https://wa.me/8801330513726?text=Hello%20I%20have%20ordered%20Hair%20Trimmer%20Order%20ID:%20DM${orderId}" 
                        ...
                        <div class="container-fluid mt-3">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-success" onclick="exportToCSV()">
                                    <i class="fas fa-file-csv"></i> Export Orders to CSV
                                </button>
                                <a href="/admin/customers-csv" class="btn btn-info">
                                    <i class="fas fa-users"></i> Export Customers CSV
                                </a>
                            </div>
                        ...
                        <script>
                            ...
                            function exportToCSV() {
                                const csvContent = "data:text/csv;charset=utf-8," 
                                    + "Order ID,Customer Name,Phone,Address,Shipping Area,Quantity,Total,Status,Date\\n"
                                    + ${orders.map(order => 
                                        `"#DM${order.id}","${order.customer_name}","${order.phone}","${order.address}","${order.shipping_area}","${order.quantity}","${order.total}","${order.status}","${new Date(order.created_at).toLocaleString()}"`
                                    ).join("\\n")};
